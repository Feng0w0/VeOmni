...
# ================================================================
# Patch: Qwen3_5VisionAttention.forward
...
# ================================================================
# Patch: Qwen3_5VisionModel.forward
...
# ================================================================
def Qwen3_5VisionModel_forward(
    self: Qwen3_5VisionModel, hidden_states: torch.Tensor, grid_thw: torch.Tensor, **kwargs
) -> torch.Tensor:
    """
    Args:
...
# ================================================================
# Patch: Qwen3_5VisionModel.dummy_forward
...
# ================================================================
# Patch: Qwen3_5VisionModel.rot_pos_emb
...
# ================================================================
# Patch: Qwen3_5VisionModel.fast_pos_embed_interpolate
...
# 1. wrapped Qwen3_5Model.get_rope_index to use in process_sample for obtaining position_ids in advance
...
class Qwen3_5ForConditionalGeneration(_Qwen3_5ForConditionalGeneration):
    ...
    def get_position_id_func(self):
        ...
        return partial(get_position_id, Qwen3_5Model.get_rope_index, fake_model)
...
def apply_veomni_qwen35_patch():
    ...
    hf_qwen35.Qwen3_5ForConditionalGeneration = Qwen3_5ForConditionalGeneration
    hf_qwen35.Qwen3_5Model = Qwen3_5Model
    hf_qwen35.Qwen3_5VisionModel.dummy_forward = Qwen3_5VisionModel_dummy_forward
    hf_qwen35.Qwen3_5VisionModel.forward = Qwen3_5VisionModel_forward
